...
int main() {
    ...
    */
    ...
    // Print to files
    printDistToFile(meanSquareDisplacement, timeBins, "MSD");
    printDistToFile(probabilityDistribution1, spaceBins1, "PDist1");
    printDistToFile(probabilityDistribution2, spaceBins2, "PDist2");
    printDistToFile(probabilityDistribution3, spaceBins3, "PDist3");
    printDistToFile(f_s1, timeBins, "f_s1");
    printDistToFile(f_s2, timeBins, "f_s2");
    printDistToFile(f_s3, timeBins, "f_s3");

    printDistToFile(meanSquareDisplacementThy, timeBins, "MSD Theory");
    printDistToFile(probabilityDistribution1Thy, spaceBins1, "PDist1 Theory");
    printDistToFile(probabilityDistribution2Thy, spaceBins2, "PDist2 Theory");
    printDistToFile(probabilityDistribution3Thy, spaceBins3, "PDist3 Theory");
    printDistToFile(f_s1Thy, timeBins, "f_s1 Theory");
    printDistToFile(f_s2Thy, timeBins, "f_s2 Theory");
    printDistToFile(f_s3Thy, timeBins, "f_s3 Theory");
