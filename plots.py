...
XMS, YMS = np.loadtxt('MSD.dat', delimiter=',', unpack=True)
#hand check
#XMSH = T_Range
#YMSH = np.loadtxt('handcheck_mean_squares.dat', unpack=True)

#probability distribution data 1
XP1, YP1 = np.loadtxt('PDist1.dat', delimiter=',', unpack=True)
XP1 = R_Range
XP10 = XP1[YP1 != 0]
YP10 = YP1[YP1 != 0]
#hand check
...
XP2, YP2 = np.loadtxt('PDist2.dat', delimiter=',', unpack=True)
XP2 = R_Range
XP20 = XP2[YP2 != 0]
YP20 = YP2[YP2 != 0]
#hand check
...
XP3, YP3 = np.loadtxt('PDist3.dat', delimiter=',', unpack=True)
XP3 = R_Range
XP30 = XP3[YP3 != 0]
YP30 = YP3[YP3 != 0]
#hand check
...
XF1, YF1 = np.loadtxt('f_s1.dat', delimiter=',', unpack=True)
#hand check
#XF1H = T_Range
#YF1H = np.loadtxt('handcheck_f_s_q1.dat', unpack=True)
#self-intermediate scattering function data 1
XF2, YF2 = np.loadtxt('f_s2.dat', delimiter=',', unpack=True)
#hand check
#XF2H = T_Range
#YF2H = np.loadtxt('handcheck_f_s_q2.dat', unpack=True)
#self-intermediate scattering function data 1
XF3, YF3 = np.loadtxt('f_s3.dat', delimiter=',', unpack=True)
#hand check
#XF3H = T_Range
...
XF1_T, YF1_T = np.loadtxt('f_s1 Theory.dat', delimiter=',', unpack=True)
#hand check
#XF1H_T = T_Range
#YF1H_T = np.loadtxt('handcheck_f_s_thy_q1.dat', unpack=True)
#self-intermediate scattering function theory 1
XF2_T, YF2_T = np.loadtxt('f_s2 Theory.dat', delimiter=',', unpack=True)
#hand check
#XF2H_T = T_Range
#YF2H_T = np.loadtxt('handcheck_f_s_thy_q2.dat', unpack=True)
#self-intermediate scattering function theory 1
XF3_T, YF3_T = np.loadtxt('f_s3 Theory.dat', delimiter=',', unpack=True)
#hand check
#XF3H_T = T_Range
