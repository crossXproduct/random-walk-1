...
## E. Aaron
## 07-07-2021
## Plots data and_thy against hand checks, as well as data against_thy. 14 plots total.
...
#hand check
X_MSD_AVG_C, Y_MSD_AVG_C = np.loadtxt('msd_avg_c.dat', delimiter=',', unpack=True)
...
Y_P1 = Y_P1[Y_P1 != 0]
#hand check
X_P1_AVG_C, Y_P1_AVG_C = np.loadtxt('pDist1_avg_c.dat', delimiter=',', unpack=True)
...
Y_P2 = Y_P2[Y_P2 != 0]
#hand check
X_P2_AVG_C, Y_P2_AVG_C = np.loadtxt('pDist2_avg_c.dat', delimiter=',', unpack=True)
...
Y_P3 = Y_P3[Y_P3 != 0]
#hand check
X_P3_AVG_C, Y_P3_AVG_C = np.loadtxt('pDist3_avg_c.dat', delimiter=',', unpack=True)
...
#hand check
X_F1_AVG_C, Y_F1_AVG_C = np.loadtxt('fs1_avg_c.dat', delimiter=',', unpack=True)
...
#hand check
X_F2_AVG_C, Y_F2_AVG_C = np.loadtxt('fs2_avg_c.dat', delimiter=',', unpack=True)
...
#hand check
X_F3_AVG_C, Y_F3_AVG_C = np.loadtxt('fs3_avg_c.dat', delimiter=',', unpack=True)
...
plt.scatter(X_MSD_AVG_C, Y_MSD_AVG_C, marker='x', color='cyan')
plt.scatter(X_MSD_AVG, Y_MSD_AVG, marker='.', color='red')

plt.title('mean square displacement')
plt.xlabel('time')
plt.ylabel('<R(t)^2>')
plt.legend(["Theory","Unaveraged", "Checks", "Time-Averaged"])
plt.savefig("msd_avg_c.png")
plt.clf()

#pDist1
plt.scatter(X_P1_THY, Y_P1_THY, marker = '^', color= 'blue')
plt.scatter(X_P1, Y_P1, marker='o', color='green')
plt.scatter(X_P1_AVG_C, Y_P1_AVG_C, marker='x', color='cyan')
